...
const connectDB = async function () {
  try {
    ...
    //models
    db.OrganizerModel = require("../models/OrganizerModel")(
      sequelize,
      DataTypes
    );
    db.EventCategoryModel = require("../models/EventCategoryModel")(
      sequelize,
      DataTypes
    );
    db.EventModel = require("../models/EventModel")(sequelize, DataTypes);
    db.MemberModel = require("../models/MemberModel")(sequelize, DataTypes);
    db.EventMemberRelModel = require("../models/EventMemberRelModel")(
      sequelize,
      DataTypes
    );
    ...
    db.MemberModel.belongsTo(db.OrganizerModel);
    // 1:M
    db.OrganizerModel.hasMany(db.EventModel, {onDelete: "cascade"});
    db.EventModel.belongsTo(db.OrganizerModel);
